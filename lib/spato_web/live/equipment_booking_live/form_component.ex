  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.simple_form
        ...
        phx-submit="save"
      >
        <.input field={@form[:requested_quantity]} type="number" label="Requested quantity" />
        <.input field={@form[:location]} type="text" label="Location" />
        <.input field={@form[:usage_at]} type="datetime-local" label="Usage at" />
        <.input field={@form[:return_at]} type="datetime-local" label="Return at" />
