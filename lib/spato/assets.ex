defmodule Spato.Assets do
  ...
  def count_meeting_rooms do
    Repo.aggregate(MeetingRoom, :count, :id)
  end

  def count_meeting_rooms_by_status(status) do
    Repo.aggregate(from(m in MeetingRoom, where: m.status == ^status), :count, :id)
  end
