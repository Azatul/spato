defmodule Spato.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    has_many :catering_menus, Spato.Assets.CateringMenu, on_delete: :delete_all
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Spato.Repo)
  ...
  """
  def valid_password?(%Spato.Accounts.User{hashed_password: hashed_password}, password)
