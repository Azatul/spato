defmodule Spato.BookingsTest do
  ...
  describe "equipment_bookings" do
    ...
    @invalid_attrs %{status: nil, location: nil, quantity: nil, usage_at: nil, return_at: nil, additional_notes: nil, condition_before: nil, condition_after: nil}
    ...
    test "create_equipment_booking/1 with valid data creates a equipment_booking" do
      valid_attrs = %{status: "some status", location: "some location", quantity: 42, usage_at: ~U[2025-09-21 06:50:00Z], return_at: ~U[2025-09-21 06:50:00Z], additional_notes: "some additional_notes", condition_before: "some condition_before", condition_after: "some condition_after"}
      ...
      assert equipment_booking.usage_at == ~U[2025-09-21 06:50:00Z]
      assert equipment_booking.return_at == ~U[2025-09-21 06:50:00Z]
    ...
    test "update_equipment_booking/2 with valid data updates the equipment_booking" do
      equipment_booking = equipment_booking_fixture()
      update_attrs = %{status: "some updated status", location: "some updated location", quantity: 43, usage_at: ~U[2025-09-22 06:50:00Z], return_at: ~U[2025-09-22 06:50:00Z], additional_notes: "some updated additional_notes", condition_before: "some updated condition_before", condition_after: "some updated condition_after"}
      ...
      assert equipment_booking.usage_at == ~U[2025-09-22 06:50:00Z]
      assert equipment_booking.return_at == ~U[2025-09-22 06:50:00Z]
