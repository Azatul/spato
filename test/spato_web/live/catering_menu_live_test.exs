defmodule SpatoWeb.CateringMenuLiveTest do
  ...
  @create_attrs %{name: "some name", status: "some status", description: "some description", price_per_head: "120.5", photo_url: "some photo_url"}
  @update_attrs %{name: "some updated name", status: "some updated status", description: "some updated description", price_per_head: "456.7", photo_url: "some updated photo_url"}
  @invalid_attrs %{name: nil, status: nil, description: nil, price_per_head: nil, photo_url: nil}
