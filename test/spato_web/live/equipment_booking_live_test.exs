defmodule SpatoWeb.EquipmentBookingLiveTest do
  ...
  @create_attrs %{status: "some status", location: "some location", requested_quantity: 42, usage_at: "2025-09-22T09:02:00Z", return_at: "2025-09-22T09:02:00Z", additional_notes: "some additional_notes", condition_before: "some condition_before", condition_after: "some condition_after"}
  @update_attrs %{status: "some updated status", location: "some updated location", requested_quantity: 43, usage_at: "2025-09-23T09:02:00Z", return_at: "2025-09-23T09:02:00Z", additional_notes: "some updated additional_notes", condition_before: "some updated condition_before", condition_after: "some updated condition_after"}
