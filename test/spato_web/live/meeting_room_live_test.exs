defmodule SpatoWeb.MeetingRoomLiveTest do
  ...
  @create_attrs %{name: "some name", status: "some status", location: "some location", features: "some features", capacity: 42, availability: "some availability", image_url: "some image_url"}
